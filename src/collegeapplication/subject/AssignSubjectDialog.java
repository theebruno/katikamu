...
public class AssignSubjectDialog extends JDialog implements ActionListener {
	...
	private AssignSubjectDialog(Faculty f) {
		...
		JLabel lblFacultyName = new JLabel("Teacher Name  :  "+f.getFacultyName());
		...
		JLabel lblFacultyId = new JLabel("Teacher ID  : "+f.getFacultyId());
		...
		JLabel lblSelectSemyear = new JLabel("Term :");
		...
		positioncombo.setModel(new DefaultComboBoxModel<String>(new String[] {"---Select Position---", "Full Teacher", "Associate Teacher", "Assistant Teacher", "Part Time Teacher", "Helper"}));
