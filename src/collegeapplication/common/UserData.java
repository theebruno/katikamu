...
public class UserData {
	Connection con=DataBaseConnection.getConnection();
			...
			public ArrayList<User> getUserInfo(String condition)
			{
				...
				try
				{
					String query="select courcecode as 'Cource',semoryear as 'Term',userid as 'Userid',logintime as 'Login Time',userprofile as 'User Profile' from users "+condition+" order by sr_no desc";
