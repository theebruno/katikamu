...
public class SearchPanel extends JPanel implements ActionListener {
	...
	public SearchPanel() {
		...
		studentandfacultycombo.setModel(new DefaultComboBoxModel<String>(new String[] {"Students", "Teachers"}));
	...
	public void createtablemodel()
	{
		...
		if(studentandfacultycombo.getSelectedIndex()==0)
		{
			String defaultquery="select s.courcecode as 'Class' ,s.rollnumber as 'Roll Number',concat(s.firstname,' ',s.lastname) as 'Student Name',c.courcename as 'Class Name',concat(c.semoryear,'-',s.semoryear) as 'Term' from students s left join cources c on s.courcecode=c.courcecode ";
		...
		{
			String defaultquery="select facultyid as 'Teacher ID',facultyname as 'Teacher Name',emailid as 'Email ID',qualification as 'Qualification',experience as 'Experience' from faculties f ";
			String query=defaultquery;
			if(courcenamecombo.getSelectedIndex()>0)
			{
				String courcecode=new CourceData().getCourcecode(courcenamecombo.getSelectedItem()+"");
